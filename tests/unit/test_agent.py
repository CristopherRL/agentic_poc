...
async def test_run_agent_sql_route(monkeypatch):
    async def fake_decide_route(question: str) -> str:
        assert question == "How many contracts?"
        return agent_module.SQL_ROUTE

    async def fake_sql_pipeline(question: str, include_intermediate_steps: bool):
...
async def test_run_agent_rag_route(monkeypatch):
    ...
    async def fake_rag_pipeline(question: str, include_intermediate_steps: bool):
        return {
            "output": "RAG answer",
...
async def test_run_agent_hybrid_route(monkeypatch):
    ...
    async def fake_hybrid_pipeline(question: str, include_intermediate_steps: bool):
        return {
...
async def test_run_agent_insufficient_context(monkeypatch):
    async def fake_decide_route(question: str):
        return None
